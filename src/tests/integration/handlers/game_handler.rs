#[cfg(test)]
mod tests {
    use crate::handlers::{get_game, get_stats, get_stats_by_owner};
        ...
        fixture
            .with_test_user_and_game(|_username, jwt, game, app_state| async move {
                ...
                let req = test::TestRequest::get()
                    .uri("/stats")
                    .cookie(Cookie::new("auth_token", jwt))
                    .to_request();
        ...
        fixture
            .with_test_user(|_username, _jwt, app_state| async move {
                let other_jwt = app_state
                    .auth_service
                    .create_jwt("false_username".to_string())
                ...
                let req = test::TestRequest::get()
                    .uri("/stats")
                    .cookie(Cookie::new("auth_token", other_jwt))
                    .to_request();
                let resp = test::call_service(&app, req).await;
