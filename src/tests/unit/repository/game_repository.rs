...
mod tests {
    ...
    async fn test_upsert_get_game_success() {
        ...
        fixture
            .with_test_user_and_game(|username, _user_repo, game_repo| async move {
                ...
                let game = GameBuilder::new(&username)
                    .with_score(100)
                    .with_level(10)
                    .with_lines(10)
                    .build();
    ...
    async fn test_get_game_by_owner_not_found() {
        ...
        assert_repository_not_found!(
            fixture
                .game_repo
                .get_game_by_owner(&fixture.random_user_name())
                .await
        );
    }
    ...
    async fn test_get_game_stats_by_owner_not_found() {
        ...
        assert_repository_not_found!(
            fixture
                .game_repo
                .get_game_stats_by_owner(&fixture.random_user_name())
                .await
        );
    }
}
