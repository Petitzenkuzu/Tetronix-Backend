...
mod tests {
    ...
    use crate::repository::{UserRepository, UserRepositoryTrait};
    use crate::tests::unit::helpers::repository_helpers::RepositoryTestFixture;
    use crate::{
        assert_repository_already_exists, assert_repository_invalid_input,
    ...
    async fn test_create_user_success() {
        ...
        fixture
            .with_test_user(|username: String, user_repo: UserRepository| async move {
    ...
    async fn test_delete_user_success() {
        let fixture = RepositoryTestFixture::new().await;
        fixture
            .with_test_user(|_: String, _: UserRepository| async move {
