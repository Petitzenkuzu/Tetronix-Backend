...
#[get("/user")]
pub async fn get_user(session : Session, state: Data<AppState>, _req: HttpRequest) -> Result<impl Responder, AppError> {
...
#[get("/leaderboard")]
pub async fn get_leaderboard(_session : Session,state: Data<AppState>, _req: HttpRequest) -> Result<impl Responder, AppError> {
